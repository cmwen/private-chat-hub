...
/// Service for managing saved LM Studio connection profiles.
class LmStudioConnectionService {
  final SharedPreferences _prefs;

  static const String _connectionsKey = 'lmstudio_connections';
  static const String _defaultConnectionKey = 'lmstudio_default_connection_id';
  static const String _legacyConnectionKey = 'lmstudio_connection';

  LmStudioConnectionService(this._prefs);

  List<LmStudioConnection> getConnections() {
  ...
  Future<LmStudioConnection> addConnection({
    ...
    final connection = LmStudioConnection(
      id: const Uuid().v4(),
      name: name,
      host: host,
      port: port,
  ...
  Future<void> updateConnection(LmStudioConnection connection) async {
    final connections = getConnections();
  ...
  LmStudioConnection? getDefaultConnection() {
    final connections = getConnections();
  ...
  void _migrateLegacyConnectionIfNeeded() {
    ...
    try {
      final legacy = LmStudioConnection.fromJson(
