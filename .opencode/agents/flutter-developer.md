...
This is **Private Chat Hub** - a privacy-first Android app for chatting with self-hosted AI models via Ollama. Key technologies:
- **Framework**: Flutter 3.10.1+ with Dart 3.10.1+
- **Platform**: Android (Java 17, Gradle 8.0+)
- **State**: Provider/ChangeNotifier patterns
- **Storage**: SharedPreferences, path_provider
- **Networking**: http package for Ollama API
- **UI**: Material Design 3, flutter_markdown for AI responses
