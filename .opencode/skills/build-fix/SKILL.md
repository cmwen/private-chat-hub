...
- Check memory in `android/gradle.properties` (4GB local, 3GB CI)
...
3. `android/app/build.gradle.kts` - App Gradle config (Java 17, R8 enabled)
4. `android/gradle.properties` - Local build settings (4GB heap, 4 workers)
5. `android/gradle-ci.properties` - CI settings (3GB heap, 2 workers)
